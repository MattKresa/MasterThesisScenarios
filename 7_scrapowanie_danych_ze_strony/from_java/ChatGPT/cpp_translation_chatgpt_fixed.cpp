        ...
        if (classAttr == "quote") {
            ...
            for (unsigned int i = 0; i < children->length; ++i) {
                ...
                if (child->type == GUMBO_NODE_ELEMENT) {
                    ...
                    // tags
                    else if (child->v.element.tag == GUMBO_TAG_DIV && getAttr(child, "class") == "tags") {
                        ...
                        for (unsigned int j = 0; j < sub_children->length; ++j) {
                            ...
                            if (sub_child->type == GUMBO_NODE_ELEMENT &&
                                ...
                                std::string(gumbo_get_attribute(&sub_child->v.element.attributes, "class")->value) == "author") {
                                quoteData["author"] = static_cast<GumboNode*>(sub_child->v.element.children.data[0])->v.text.text;
                            }
                        }
                    }
                }
