...
vector<vector<double>> dot_scalar(const vector<vector<double>>& a, double scalar) {
...
int main() {
    ...
    for (int epoch = 0; epoch < epochs; ++epoch) {
        ...
        // Update weights
        W2 = W2 - dot_scalar(dW2, learning_rate);
        b2 = b2 - dot_scalar(db2, learning_rate);
        W1 = W1 - dot_scalar(dW1, learning_rate);
        b1 = b1 - dot_scalar(db1, learning_rate);
