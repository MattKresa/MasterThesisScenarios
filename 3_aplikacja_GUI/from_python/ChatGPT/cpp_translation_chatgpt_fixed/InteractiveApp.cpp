...
void InteractiveApp::show_message() {
...
void InteractiveApp::save_settings(const QString &name, const QString &color, bool emoji, int font_size) {
    QJsonObject obj;
    obj["name"] = name;
    obj["color"] = color;
    obj["emoji"] = emoji;
...
void InteractiveApp::load_settings() {
    QFile file(SAVE_FILE);
