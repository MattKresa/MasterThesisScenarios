...
int main() {
    // For a simple random start point, we can just define it directly.
    Vector start_point = { 1.2, -0.5, 2.1, -1.8, 0.9 };

    Vector minimum_vec = gradient_descent(f, start_vec = start_point, init_lr = 0.05);
