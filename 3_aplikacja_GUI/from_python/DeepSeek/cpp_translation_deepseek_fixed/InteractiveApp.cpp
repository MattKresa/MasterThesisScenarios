...
void InteractiveApp::saveSettings()
{
    QJsonObject data;
    data["name"] = name_input->text();
    data["color"] = color_dropdown->currentText();
    data["emoji"] = emoji_check->isChecked();
    data["font_size"] = font_slider->value();
